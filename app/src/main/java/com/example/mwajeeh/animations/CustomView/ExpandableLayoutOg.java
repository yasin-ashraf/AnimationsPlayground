...
import static com.example.mwajeeh.animations.CustomView.ExpandableLayoutOg.State.COLLAPSED;
import static com.example.mwajeeh.animations.CustomView.ExpandableLayoutOg.State.COLLAPSING;
import static com.example.mwajeeh.animations.CustomView.ExpandableLayoutOg.State.EXPANDED;
import static com.example.mwajeeh.animations.CustomView.ExpandableLayoutOg.State.EXPANDING;

/**
 * Created by im_yasinashraf started on 1/8/17.
 */

public class ExpandableLayoutOg extends FrameLayout {
    ...
    public ExpandableLayoutOg(Context context) {
        this(context, null);
    }

    public ExpandableLayoutOg(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableLayoutOg);
            duration = a.getInt(R.styleable.ExpandableLayoutOg_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ExpandableLayoutOg_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ExpandableLayoutOg_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ExpandableLayoutOg_el_parallax, 1);
            a.recycle();
    ...
    private void animateSize(int targetExpansion) {
        ...
        animator.addUpdateListener(valueAnimator -> setExpansionInternal((float) valueAnimator.getAnimatedValue()));
